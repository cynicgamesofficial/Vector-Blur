...
Motion blur effect for GZDoom,LZDoom,UZDoom that actually works. Uses proper velocity tracking so it only blurs when you're actually moving, not when you're just pressing keys against a wall.
